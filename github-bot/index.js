...
module.exports = (app) => {
  ...
  const { incremental_calculateCurrentCodeChurn, incremental_calculateCurrentBugFrequencies, incremental_calculateCurrentCoChangeFiles, incremental_updateBranch, incremental_calculateRiskScore, incremental_calculateMergeRate, incremental_calculate_pagerank, incremental_generate_save_impact_graph } = incrementalAnalysisMethods();
  ...
  app.on("pull_request.opened", async (context) => {
    ...
    if(destinationBranchName == default_branch){
      ...
      await addComment(context, pullRequest, settings, impactGraphUrl);
    }
  });
  ...
  app.on("pull_request.synchronize", async (context) => {
    ...
    if(destinationBranchName == default_branch){
      ...
      addComment(context, pullRequest, settings, impactGraphUrl);
    }
  });
