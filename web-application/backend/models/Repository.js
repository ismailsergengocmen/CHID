	...
	metric_management: {
		...
		pr_size: {
			...
			e: {
				...
				upper_bound: { type: Number, default: 30000 },
			},
		},
		author_merge_rate: {
			a: {
...
const repoSchema = new Schema({
	...
	is_initial_call_graph_built: { type: Boolean, default: false },
	project_tags: [String],
